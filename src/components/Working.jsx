...
useEffect(() => {
  ...
  return (
    <div className="container mx-auto px-4 py-1 max-w-4xl">
      <h1 className="text-center mt-[30px] text-4xl md:text-5xl font-bold h-[55px] mb-3 bg-gradient-to-r from-blue-600 to-purple-600 text-transparent bg-clip-text font-serif">
        Your Working Tasks
      </h1>
